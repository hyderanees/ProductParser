...
def product_competitor_job(ijd):
    cron_ = CronJobLogRunning.objects.create(cron_job_type=1)
    ijd = InstantJobDeclaration.objects.get(id=ijd)
    ...
    for prod in products:
        ...
        ijd.status_of_job = ijd.status_of_job + 1
        if is_price_change:
            ijd.products_price_changes = ijd.products_price_changes + 1
        ijd.save()
